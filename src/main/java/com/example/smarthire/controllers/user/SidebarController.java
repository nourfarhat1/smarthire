...
public class SidebarController {
    ...
    @FXML void goToCandidateTrainingDisplay() { Navigation.loadContent("/com/example/smarthire/fxml/fxmls/frontend/candidate/CandidateTrainingDisplay.fxml"); }
    // --- HR ---
    ...
    @FXML void goToJOBRequest() { Navigation.loadContent("/com/example/smarthire/fxml/fxmls/frontend/hr/HRJobRequest.fxml"); }
    // --- ADMIN ---
    ...
    @FXML void goToAdminTrainings() { Navigation.loadContent("/com/example/smarthire/fxml/fxmls/backend/AdminTraining.fxml"); }
    @FXML
