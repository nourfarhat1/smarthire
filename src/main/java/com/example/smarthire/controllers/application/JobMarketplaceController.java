...
public class JobMarketplaceController {
    ...
    public void initialize() {
        ...
        // Custom cell factory for job cards
        ...
        dialog.setResultConverter(dialogButton -> {
            if (dialogButton == applyType) {
                return new JobRequest(
                        SessionManager.getUser().getId(),  // candidateId
                        offer.getId(),                     // jobOfferId
                        offer.getTitle(),                  // jobTitle
                        offer.getLocation(),               // location
                        cvField.getText().trim(),          // cvUrl
                        letterArea.getText().trim(),       // coverLetter
                        null,                              // suggestedSalary
                        null              // ✅ NEW ATTRIBUTE
                );
            }
            return null;
