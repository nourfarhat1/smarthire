...
public class AdminComplaintController {
    ...
    private void showDetails(Complaint c) {
        ...
        // Updated to show Name alongside ID
    ...
    private void handleTranslateAction() {
        ...
        recapLabel.setText("Translating complaint...");
        aiProgress.setVisible(true);

        javafx.concurrent.Task<String> translationTask = new javafx.concurrent.Task<>() {
            @Override
            protected String call() {
                // "Autodetect" to English (en)
                return TranslationService.translate(selectedComplaint.getDescription(), "autodetect", "en");
            }
        };

        translationTask.setOnSucceeded(e -> {
            recapLabel.setText("TR: " + translationTask.getValue());
            aiProgress.setVisible(false);
        });
