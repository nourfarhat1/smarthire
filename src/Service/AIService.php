...
class AIService
{
    ...
    public function __construct(
        ...
        $this->apiKey = $parameterBag->get('app.ai_api_key', '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');
    ...
    public function analyzeResume(string $text): array
    {
        ...
        $prompt = "Extract candidate info. Return ONLY a JSON object with: firstName, lastName, phone, skills (array), summary. Text: " . $this->cleanForJson($text);
    ...
    public function calculateEventMatching(string $candidateSkills, string $eventDescription): array
    {
        ...
        // --- DEBUG MESSAGE ---
        echo "\n[DEBUG-AI-PROCESS] =======================================\n";
        echo "[DEBUG-AI-PROCESS] Skills reçus : '" . $cleanSkills . "'\n";
        ...
        if (empty($cleanSkills) || $cleanSkills === ",") {
            echo "[DEBUG-AI-PROCESS] ALERTE : Compétences vides. IA non appelée.\n";
            echo "[DEBUG-AI-PROCESS] =======================================\n\n";
        ...
        echo "[DEBUG-AI-PROCESS] Envoi à l'IA pour l'événement : " . 
            (strlen($eventDescription) > 40 ? substr($eventDescription, 0, 40) . "..." : $eventDescription) . "\n";
        ...
        // --- DEBUG RÉSULTAT ---
        echo "[DEBUG-AI-RESULT] Score calculé : " . ($response['score'] ?? 'unknown') . "\n";
        echo "[DEBUG-AI-PROCESS] =======================================\n\n";
    ...
    private function callGroq(string $prompt): array
    {
        ...
        if ($response->getStatusCode() !== 200) {
            echo "[DEBUG-AI] Groq API Error: " . $response->getStatusCode() . "\n";
