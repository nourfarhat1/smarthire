...
#[Route('/hr/complaints')]
#[IsGranted('ROLE_HR')]
class HRComplaintController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        // Get HR user complaints with filtering
        ...
        return $this->render('hr/complaints/index.html.twig', [
    ...
    #[Route('/new', name: 'app_hr_complaints_new', methods: ['GET', 'POST'])]
    public function new(Request $request): Response
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($hasBadWord || $subjectAnalysis['containsProfanity'] || $descriptionAnalysis['containsProfanity']) {
                ...
                return $this->render('hr/complaints/new.html.twig', [
                    'types' => $types,
            ...
            return $this->redirectToRoute('app_hr_complaints_show', ['id' => $complaint->getId()]);
        }
    ...
    #[Route('/{id}/edit', name: 'app_hr_complaints_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Complaint $complaint): Response
    {
        ...
        // Check if the complaint is still pending (HR can only edit pending complaints)
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($hasBadWord || $subjectAnalysis['containsProfanity'] || $descriptionAnalysis['containsProfanity']) {
                ...
                return $this->render('hr/complaints/edit.html.twig', [
                    'complaint' => $complaint,
                    'types' => $types,
                    'filteredSubject' => $filteredSubject,
                    'filteredDescription' => $filteredDescription,
            ...
            if (empty($subject) || empty($description) || empty($typeId)) {
                $this->addFlash('error', 'Please fill in all required fields.');
                return $this->redirectToRoute('app_hr_complaints_edit', ['id' => $complaint->getId()]);
            }
    ...
    #[Route('/{id}/delete', name: 'app_hr_complaints_delete', methods: ['POST'])]
    public function delete(Request $request, Complaint $complaint): Response
    {
        ...
        // Check if the complaint is still pending (HR can only delete pending complaints)
        if ($complaint->getStatus() !== 'PENDING') {
        ...
        return $this->redirectToRoute('app_hr_complaints');
    }

    #[Route('/{id}', name: 'app_hr_complaints_show')]
    public function show(Complaint $complaint): Response
    {
        ...
        return $this->render('hr/complaints/show.html.twig', [
            'complaint' => $complaint,
        ]);
    }
}
